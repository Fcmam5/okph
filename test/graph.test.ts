...
describe("buildGraph", () => {
  ...
  it("keeps edges out of reserved files — exclusion is a traversal decision", () => {
    const g = buildGraph([
      ...
      { path: "log.md", title: "Log", links: [{ text: "B", href: "b.md", kind: "internal" as const, target: "b.md" }] },
      { path: "b.md", title: "B", links: [] },
    ]);
    expect(g.edges).toEqual([
      { from: "docs/index.md", to: "b.md" },
      { from: "index.md", to: "b.md" },
      { from: "log.md", to: "b.md" },
    ]);
  });

  it("keeps links into a reserved file as ordinary edges", () => {
    const g = buildGraph([
